...
def add_linked_lists(l1, l2):
    ...
    just the add_linked_lists(l1, l2) = 975
    ...
    """
    # go thru each LL and create a string of the node data in reverse.
    # convert to ints & add.
    # convert to a LL
    ...
    total = str(int(str_1) + int(str_2))

    out_node = None
    
    while total:
        out_node = Node(total[0], out_node)
        total = total[1:]
    return out_node
